		...
		<Box>
			...
			<Box sx={{ display: 'flex', height:"100vh" }}>
				...
				<Drawer variant="permanent" elevation={1} open={open} sx={{ backgroundColor: '#000000', height:"100vh" }}>
					...
					<Divider />
					<List>
						<Link to="/physiotherapist/dashboard" style={{textDecoration:"none"}}onClick={() => handleMenuItemClick('Dashboard')}>
						...
						<Link to="/physiotherapist/students" style={{textDecoration:"none"}} onClick={() => handleMenuItemClick('Students')}>
							<ListItem disablePadding sx={{ display: 'block' }} >
						...
						<Link to="/physiotherapist/schedule" style={{textDecoration:"none"}}>
						...
						<Link to="/physiotherapist/shakebar" style={{textDecoration:"none"}}>
						...
						<Link to="/physiotherapist/reports" style={{textDecoration:"none"}}>

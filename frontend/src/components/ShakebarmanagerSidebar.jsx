...
import { FaBars, FaTachometerAlt, FaCocktail, FaClipboardList, FaFacebook, FaInstagramSquare, FaTwitter,FaShoppingCart } from 'react-icons/fa';
    ...
    <Box>
      ...
      <Box sx={{ display: 'flex', height:"100vh" }}>
          ...
          <Drawer variant="permanent" elevation={1} open={open} sx={{ backgroundColor: '#000000', height:"100vh" }}>
              ...
              <Link to="/shakebarmanager/items" style={{textDecoration:"none"}}>
                <ListItem disablePadding sx={{ display: 'block' }} onClick={() => handleMenuItemClick('Items')}>
                  ...
                  <ListItemButtonStyled theme={theme} open={open} style={props.sidebarLinkId === "2" ? activeLinkStyle : {}}>
                    ...
                    {open && <SidebarLink variant="subtitle1" component="span">Items</SidebarLink>}
                  </ListItemButtonStyled>
                </ListItem>
              </Link>
              ...
              <Link to="/shakebarmanager/orders" style={{textDecoration:"none"}}>
                <ListItem disablePadding sx={{ display: 'block' }} onClick={() => handleMenuItemClick('Orders')}>
                  ...
                  <ListItemButtonStyled theme={theme} open={open} style={props.sidebarLinkId === "3" ? activeLinkStyle : {}}>
                    ...
                    {open && <SidebarLink variant="subtitle1" component="span">Orders</SidebarLink>}
                  </ListItemButtonStyled>
                </ListItem>
              </Link>
            ...
            <Box sx={{ display: open? 'flex' : 'none', marginTop: '160%',width:"100%", justifyContent:"center", alignItems:"center",textAlign:"center", marginLeft:"0.5rem"}}>

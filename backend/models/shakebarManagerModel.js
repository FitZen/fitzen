...
// active shakebar manager count
const activeShakebarManagerCount = asyncHandler(async () => {
    const sql = 'SELECT count(id) FROM users WHERE type = \'Shake Bar Manager\' AND status = \'Active\';';
    const result = await query(sql);

...
// const addNewPhysicalMember = asyncHandler(async (memberData, healthInfoData, addedByUserId) => { // methana profile picture eka add kre na
...
//     const result = await query(physicalMemberSql, healthInfoSql, [ memberData.id, memberData.nic, memberData.first_name]);
